...
class RelatorioDiferencas extends TPage
{
    ...
    public function __construct($param)
    {
        ...
        if($_SERVER['SERVER_NAME'] == "localhost"){
            $link = "http://localhost/portal-mrk/external/relatorioDiferencas.html?username={$username}&token={$token}";
        }else{
            $link = "https://portal.mrksolucoes.com.br/external/relatorioDiferencas.html?username={$username}&token={$token}";
        }
