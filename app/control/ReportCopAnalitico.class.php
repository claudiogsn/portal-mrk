<?php
class ReportCopAnalitico extends TPage
{
    private $form;
    ...
    public function __construct($param)
    {
        ...
        if ($_SERVER['SERVER_NAME'] == "localhost") {
            $link = "http://localhost/portal-mrk/external/copAnalitico.html?token={$token}&unit_id={$system_unit_id}&unit_name={$unit_name}";
        } else {
            $link = "https://portal.mrksolucoes.com.br/external/copAnalitico.html?token={$token}&unit_id={$system_unit_id}&unit_name={$unit_name}";
        }
