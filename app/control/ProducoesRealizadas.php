<?php
class ProducoesRealizadas extends TPage
{
    private $form;
    public function __construct($param)
    {
        ...
        if($_SERVER['SERVER_NAME'] == "localhost"){
            $link = "http://localhost/portal-mrk/external/listProducoesRealizadas.html?username={$username}&token={$token}&unit_id={$unit_id}";
        }else{
            $link = "https://portal.mrksolucoes.com.br/external/listProducoesRealizadas.html?username={$username}&token={$token}&unit_id={$unit_id}";
        }
