<?php
class OpenFinanceTransacoes extends TPage
{
    private $form;
    ...
    public function __construct($param)
    {
        ...
        if ($_SERVER['SERVER_NAME'] == "localhost") {
            $link = "http://localhost/portal-mrk/external/OFTransactions.php";
        } else {
            $link = "https://portal.mrksolucoes.com.br/external/OFTransactions.php";
        }
