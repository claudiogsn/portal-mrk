<?php
class OpenFinancePagadores extends TPage
{
    private $form;
    ...
    public function __construct($param)
    {
        ...
        if ($_SERVER['SERVER_NAME'] == "localhost") {
            $link = "http://localhost/portal-mrk/external/OFListPayers.php";
        } else {
            $link = "https://portal.mrksolucoes.com.br/external/OFListPayers.php";
        }
