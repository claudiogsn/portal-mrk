<?php
class   PerdasEstoque extends TPage
{
    private $form;
    public function __construct($param)
    {
        ...
        if($_SERVER['SERVER_NAME'] == "localhost"){
            $link = "http://localhost/portal-mrk/external/lancarPerdas.html?username={$username}&token={$token}&unit_id={$unit_id}";
        }else{
            $link = "https://portal.mrksolucoes.com.br/external/lancarPerdas.html?username={$username}&token={$token}&unit_id={$unit_id}";
        }
