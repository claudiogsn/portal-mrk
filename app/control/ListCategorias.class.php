<?php
class ListCategorias extends TPage
{
    private $form;
    public function __construct($param)
    {
        ...
        if($_SERVER['SERVER_NAME'] == "localhost"){
            $link = "http://localhost/portal-mrk/external/listCategorias.html?user={$username}&token={$token}&system_unit_id={$unit_id}";
        }else{
            $link = "https://portal.mrksolucoes.com.br/external/listCategorias.html?user={$username}&token={$token}&system_unit_id={$unit_id}";
        }
