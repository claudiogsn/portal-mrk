<?php
class ListarBancos extends TPage
{
    private $form;
    public function __construct($param)
    {
        ...
        if($_SERVER['SERVER_NAME'] == "localhost"){
            $link = "http://localhost/portal-mrk/external/listBancos.html?system_unit_id={$unit_id}&token={$token}";
        }else{
            $link = "https://portal.mrksolucoes.com.br/external/listBancos.html?system_unit_id={$unit_id}&token={$token}";
        }
