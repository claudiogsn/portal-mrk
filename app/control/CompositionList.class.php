...
class CompositionList extends TPage
{
    ...
    public function __construct($param)
    {
        ...
        if($_SERVER['SERVER_NAME'] == "localhost"){
            $link = "http://localhost/portal-mrk/external/fichaTecnica.html?username={$username}&token={$token}&unit_id={$unit_id}";
        }else{
            $link = "https://portal.mrksolucoes.com.br/external/fichaTecnica.html?username={$username}&token={$token}&unit_id={$unit_id}";
        }
