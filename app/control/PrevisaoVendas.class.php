<?php
class PrevisaoVendas extends TPage
{
    private $form;
    public function __construct($param)
    {
        ...
        if($_SERVER['SERVER_NAME'] == "localhost"){
            $link = "http://localhost/portal-mrk/external/previsaoVendas.html?username={$username}&token={$token}&unit_id={$unit_id}";
        }else{
            $link = "https://portal.mrksolucoes.com.br/external/previsaoVendas.html?username={$username}&token={$token}&unit_id={$unit_id}";
        }
