...
class ListCompras extends TPage
{
    ...
    public function __construct($param)
    {
        ...
        if($_SERVER['SERVER_NAME'] == "localhost"){
            $link = "http://localhost/portal-mrk/external/itensComprados.html?username={$username}&token={$token}&unit_id={$unit_id}";
        }else{
            $link = "https://portal.mrksolucoes.com.br/external/itensComprados.html?username={$username}&token={$token}&unit_id={$unit_id}";
        }
