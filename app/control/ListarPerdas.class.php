<?php
class ListarPerdas extends TPage
{
    private $form;
    public function __construct($param)
    {
        ...
        if($_SERVER['SERVER_NAME'] == "localhost"){
            $link = "http://localhost/portal-mrk/external/listPerdas.html?system_unit_id={$unit_id}&token={$token}";
        }else{
            $link = "https://portal.mrksolucoes.com.br/external/listPerdas.html?system_unit_id={$unit_id}&token={$token}";
        }
