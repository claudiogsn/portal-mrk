<?php
class ImportarNotasFiscaisEntrada extends TPage
{
    private $form;
    public function __construct($param)
    {
        ...
        if($_SERVER['SERVER_NAME'] == "localhost"){
            $link = "http://localhost/portal-mrk/external/importarNotasFiscais.html?username={$username}&token={$token}&unit_id={$unit_id}&unit_name={$unit_name}";
        }else{
            $link = "https://portal.mrksolucoes.com.br/external/importarNotasFiscais.html?username={$username}&token={$token}&unit_id={$unit_id}&unit_name={$unit_name}";
        }
