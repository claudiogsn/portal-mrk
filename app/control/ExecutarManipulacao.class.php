<?php
class ExecutarManipulacao extends TPage
{
    private $form;
    ...
    public function __construct($param)
    {
        ...
        if ($_SERVER['SERVER_NAME'] == "localhost") {
            $link = "http://localhost/portal-mrk/external/executarManipulacao.php";
        } else {
            $link = "https://portal.mrksolucoes.com.br/external/executarManipulacao.php";
        }
