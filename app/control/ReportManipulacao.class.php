<?php
class ReportManipulacao extends TPage
{
    private $form;
    ...
    public function __construct($param)
    {
        ...
        if ($_SERVER['SERVER_NAME'] == "localhost") {
            $link = "http://localhost/portal-mrk/external/relatorioManipulacao.php";
        } else {
            $link = "https://portal.mrksolucoes.com.br/external/relatorioManipulacao.php";
        }
